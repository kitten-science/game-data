...
export default {
	...
	duneMission: {
		description:
			"Dune is a large and lifeless planet covered by sand and volcanic rock.",
		label: "Dune Mission",
		name: "duneMission",
		prices: [
			{
	...
	heliosMission: {
		description:
			"Helios is a G2V spectral type star in the center of Cath's solar system.",
	...
	kairoMission: {
		description:
			"Kairo is a dwarf planet in the far end of Cath's solar system.",
		label: "Kairo Mission",
		name: "kairoMission",
		prices: [
			{
	...
	terminusMission: {
		description:
			"Terminus is a supermassive ice giant at the far end of Cath's solar system.",
	...
	umbraMission: {
		description:
			"Umbra is a supermassive black hole at the heart of the Helios system",
		label: "Umbra Mission",
		name: "umbraMission",
		prices: [
			{
	...
	yarnMission: {
		description:
			"Yarn is a class M planet with high moderate climate, seas and oxygen atmosphere.",
		label: "Yarn Mission",
		name: "yarnMission",
		prices: [
			{
