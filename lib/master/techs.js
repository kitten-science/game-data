...
export default {
	...
	antimatter: {
		...
		effectDesc:
			"Unlocks Antimatter Reactors, AM-Drive, AM-Fission and Antimatter Bases",
		label: "Antimatter",
		name: "antimatter",
		prices: [
			{
	...
	architecture: {
		description:
			"Architecture allows construction of some new sophisticated structures.",
	...
	artificialGravity: {
		description:
			"New anti-G engines enable a new form of long-range space travel.",
	...
	astronomy: {
		description:
			"Astronomy is the study of objects in space. Improves scientific development.",
	...
	blackchain: {
		description:
			"All cool cats are mining this, so I think it is some kind of mineral",
	...
	construction: {
		...
		effectDesc:
			"Allows your workers to construct the Lumber mill. Unlocks Composite Bows",
		effects: {
			queueCap: 1,
		},
	...
	electronics: {
		description:
			"Electronics unlocks some high level upgrades mainly related to science",
	...
	exogeology: {
		description:
			"Exogeology or Planetary Geology studies extraterrestrial metals and minerals.",
	...
	genetics: {
		...
		flavor:
			"There's an unbroken thread that stretches from those first cats to us.",
		label: "Genetics",
		name: "genetics",
		prices: [
			{
	...
	machinery: {
		...
		effectDesc:
			"Unlocks Steamworks, Crossbows, Printing Press and Factory Automation.",
		label: "Machinery",
		name: "machinery",
		prices: [
			{
	...
	nuclearFission: {
		description:
			"Nuclear Fission unlocks Nuclear Reactors and nuclear-related upgrades",
	...
	paradoxalKnowledge: {
		description:
			"Develop a framework for understanding and controlling the time-space continuum.",
		effectDesc: "Unlocks Chronocontrol and Resource Retrieval",
		flavor: "Knock that bowl off your grand-cat's table for fun and profit.",
	...
	particlePhysics: {
		...
		flavor: "Mewtrinos are strongly and electrically aloof.",
	...
	sattelites: {
		description:
			"Satellites are machines that permanently orbit the planet outside its atmosphere",
