...
export default {
	...
	bigStickPolicy: {
		...
		blocks: ["cityOnAHill"],
		description:
			"Speak softly, but beat up your neighbors when necessary. Embassies are cheaper and can be queued.",
		effects: {
	...
	cityOnAHill: {
		...
		description:
			"Be a shining example to the world you hate. Culture cap is slightly increased.",
		effects: {
	...
	clearCutting: {
		...
		description:
			"Totally destroy the forest in an effort to improve your wood production.",
		effects: {
	...
	conservation: {
		...
		description:
			"Keep actively protecting the environment, increasing happiness from environment.",
		effects: {
			cathPollutionRatio: -0.05,
	...
	feedingFrenzy: {
		...
		description:
			"Your divine feast is more effective (based on available Pacts) but causes interference with necrocorn corruption. Necrocorns corrupt at full speed between 0 and 1 necrocorns.",
		effects: {
	...
	isolationism: {
		...
		blocks: ["diplomacy"],
		description:
			"Engage in protectionism of all types, making trades cheaper in terms of gold.",
		effects: {
			tradeGoldDiscount: 1,
		},
		label: "Isolationism",
	...
	radicalXenophobia: {
		...
		description:
			"Reject both evil aliens and evil robots. Mausoleum is twice as effective.",
		effects: {
			mausoleumBonus: 1,
			pactsAvailable: 5,
		},
	...
	sharkRelationsScribes: {
		...
		description:
			"The shark scribes are keen on recording Cath's history and you can help each other in the form of a trade deal. If you give them more resources in trade, they are willing to share more of their recordings.<br>Effect increases as the years pass.",
		isRelation: true,
	...
	siphoning: {
		...
		description:
			"Pacts no longer continuously consume necrocorns. Instead, whenever a necrocorn is produced, it may be siphoned away to pay off debt. Small amounts of debt are harmless.",
		effects: {
	...
	stripMining: {
		...
		description:
			"Decapitate the hills in an effort to improve your mineral production.",
		effects: {
			cathPollutionRatio: 0.05,
			environmentUnhappiness: -2,
	...
	technocracy: {
		...
		description:
			"Your government is taken over by scientists, increasing your science cap.",
		effects: {
	...
	upfrontPayment: {
		...
		description:
			"Renegotiate Pacts to reduce upkeep cost by 10%. If there is any debt, it is more punishing.<br>Upon purchasing this policy, you must immediately pay the upfront cost for all existing Pacts.",
		effects: {
