...
export default {
	...
	beam: {
		description:
			"Simple support structure made of a wood. Required for advanced construction.",
		label: "Wooden Beam",
		name: "beam",
		prices: [
			{
	...
	bloodstone: {
		description:
			"A strange jewelry claimed to be made of time and a blood of elder gods",
		label: "Bloodstone",
		name: "bloodstone",
		prices: [
			{
	...
	eludium: {
		description:
			"Extremely rare and expensive alloy of unobtanium and titanium.",
		label: "Eludium",
		name: "eludium",
		prices: [
			{
	...
	microchip: {
		description:
			"A compact assembly of electronic circuits. Required for most electronic technologies.",
		label: "Microchip",
		name: "microchip",
		prices: [
			{
	...
	plastic: {
		description:
			"Synthetic material made from oil. Required for science and advanced technologies.",
		label: "Plastic",
		name: "plastic",
		prices: [
			{
	...
	slab: {
		description:
			"A small slab composed of minerals. Required for advanced construction.",
		label: "Stone Slab",
		name: "slab",
		prices: [
			{
