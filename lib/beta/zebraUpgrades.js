...
export default {
    "bloodstoneInstitute": {
        "description": "Foggy memory of finding it. Zebra workshops increase chance to find Bloodstones in hunts",
        "effects": {},
    ...
    "minerologyDepartment": {
        "description": "Minerology is being taught in the Academy, leading to better production from meteors",
        "effects": {},
    ...
    "whispers": {
        "description": "Unlock Alicorn Ascension rituals at Ivory Temples. Alicorn Ascension produces T-Mythril and increases mineral production.",
        "effects": {},
        "label": "Whispers",
        "name": "whispers",
        "prices": [
