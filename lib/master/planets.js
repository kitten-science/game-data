...
export default {
	...
	centaurusSystem: {
		buildings: [
			{
				description:
					"Rip open the planet near the star Centaurus to collect magma energy.",
				effects: {
					energyProduction: 0,
				},
				label: "Tectonic",
			...
			{
				description:
					"Every level of Molten Core improves Tectonic effectiveness by 5%",
				effects: {
					tectonicBonus: 0.05,
				},
				label: "Molten Core",
	...
	dune: {
		buildings: [
			{
				description:
					"USS Mining Vessel Hissmeowra that can crack an entire planet",
				effects: {
					uraniumMax: 0,
	...
	helios: {
		buildings: [
			...
			{
				description:
					"Containment Chamber. Increases antimatter storage space by 100.",
				effects: {
					antimatterMax: 0,
					energyConsumption: 0,
				},
	...
	kairo: {
		buildings: [
			{
				description:
					"An AM-powered space station used for research and interstellar navigation.",
				effects: {
					relicPerDay: 0,
					scienceMax: 25000,
