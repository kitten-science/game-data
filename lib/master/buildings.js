...
export default {
    ...
    "warehouse": {
        ...
        "stages": [
            ...
            {
                "description": "Increases the storage capacity of buildings in space. Does not affect science or antimatter.",
                "effects": {
    ...
    "zebraOutpost": {
        "description": "Provides a base for the hunting expeditions. Every level of upgrade improves expedition effectiveness by 5%",
        "effects": {
            "hunterRatio": 0.05,
            "manpowerMax": 5,
            "zebraPreparations": 0
