...
export default {
	blackPyramid: {
		...
		label: "Black Pyramid",
		name: "blackPyramid",
		prefixEffectNames: ["craftRatio", "UniversalKnowHow", "timeRatio"],
		priceRatio: 1.15,
		prices: [
			{
				name: "unobtainium",
	...
	ivoryCitadel: {
		...
		description:
			"Improves your unicorns generation by 25%, summons Ivory Meteors",
		effects: {
	...
	ivoryTower: {
		defaultUnlocked: false,
		description:
			"Improves your unicorns generation by 10%, unlocks Unicorn Rifts",
		effects: {
			riftChance: 0.0005,
			tearsMax: 0,
	...
	marker: {
		description:
			"A strange structure made of unknown metal and serving an unidentified purpose.",
		effects: {
