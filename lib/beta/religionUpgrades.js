...
export default {
	...
	frescoes: {
		description: "Chapels store faith proportional to your amount of karma.",
		faith: 200000,
		flavor:
			"Our ancestors' deeds resonate across time. We are heirs to their holy legacy.",
		label: "Frescoes",
		name: "frescoes",
		noStackable: true,
		priceRatio: 2.5,
	...
	sunAltar: {
		description:
			"Every temple can store a bit more faith and will improve happiness by 0.5%",
		effects: {},
		faith: 750,
		label: "Sun Altar",
		name: "sunAltar",
