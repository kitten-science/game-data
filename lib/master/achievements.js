...
export default {
	...
	betterSafeThanSorry: {
		...
		starDescription:
			"Get Carbon Sequestration with no pollution and without using chronospheres.",
	...
	cathammer: {
		...
		name: "cathammer",
		starDescription:
			"In the grim and dark future of a catkind there are no resets",
		title: "Cathammer 40K",
	},
	challenger: {
	...
	heartOfDarkness: {
		description:
			"Become the chieftain of a zebra tribe. (How is this even possible?)",
	...
	jupiterAscending: {
		...
		starDescription:
			"Get to space on the first year without using Chronospheres",
