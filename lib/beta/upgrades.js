...
export default {
	...
	alicornStable: {
		description: "+0.2 max alicorns",
		effects: {
			alicornMax: 0,
		},
		label: "Alicorn Stable",
		name: "alicornStable",
		prices: [
			{
				name: "wood",
	...
	alloyArmor: {
		description: "Hunts yield more resources.",
		effects: {
			explorerDef: 10,
			hunterRatio: 0.5,
		},
	...
	alloyAxe: {
		description:
			"The more you use them, the sharper they are! Woodcutters are 50% more effective.",
		effects: {
			woodJobRatio: 0.5,
		},
		label: "Alloy Axe",
	...
	alloyBarns: {
		description: "Storage facilities store 100% more resources.",
		effects: {
			barnRatio: 1,
		},
		label: "Alloy Barns",
	...
	amReactors: {
		description:
			"Your Research Vessels and Space Beacons are 95% more effective",
		effects: {
	...
	amReactorsMK2: {
		description:
			"Your Research Vessels and Space Beacons are ~77% more effective",
		effects: {
	...
	assistance: {
		description:
			"Factory robots automating routine tasks. Workers require less catnip.",
		effects: {
	...
	biofuel: {
		description:
			"Bio Labs will convert catnip into oil. Every Bio Lab will consume 1Wt/t.",
		effects: {},
	...
	bolas: {
		description:
			"Throwing weapon made of heavy stone weights. Hunts yield more resources.",
		effects: {
			explorerAtk: 2,
			hunterRatio: 1,
			manpowerMax: 0,
	...
	cadSystems: {
		description:
			"All scientific buildings will improve effectiveness of blueprint crafting",
		effects: {
	...
	celestialMechanics: {
		description:
			"Celestial events and meteors will generate additional science",
		effects: {},
	...
	chronoEngineers: {
		description:
			"Improves Engineer's effectiveness and make them work during time skip",
		effects: {
			queueCap: 3,
			t1CraftRatio: 10,
			t2CraftRatio: 5,
	...
	compositeBow: {
		description:
			"An improved version of a bow which provides a +50% boost to catpower production",
		effects: {
			explorerAtk: 5,
	...
	crossbow: {
		description:
			"An improved version of a bow which provides a +25% boost to catpower production",
		effects: {
			explorerAtk: 10,
	...
	darkEnergy: {
		description: "Energy Rifts are 250% more effective at storing resources.",
		effects: {
	...
	factoryProcessing: {
		description:
			"Every factory will increase oil refinement to kerosene effectiveness by 5%.",
		effects: {
	...
	fluidizedReactors: {
		description: "Calciners produce 100% more iron and 300% more titanium.",
		effects: {
			calcinerRatio: 1,
		},
	...
	freightfulExchange: {
		description:
			"Spaceports automation allows their usage for increased volumes of trade. The volume increases by +50% per each",
		effects: {},
		label: "Freightful Exchange",
	...
	gmo: {
		description:
			"Genetically modified catnip that will improve Bio Lab oil yield by 60%",
		effects: {
			biofuelRatio: 0.6,
		},
		label: "GM Catnip",
	...
	hydroPlantTurbines: {
		description:
			"Unobtainium-based turbines. Hydro Plants are 15% more effective.",
		effects: {
	...
	longRangeSpaceships: {
		description:
			"Unlocks Space Shuttle. Need to be staffed with a crew of two kittens",
	...
	machineLearning: {
		description:
			"Every active AI Core will increase Data Center effectiveness by 10%",
		effects: {
	...
	neuralNetworks: {
		description:
			"Doubles Engineer effectiveness. Kittens learn from the noosphere.",
		effects: {},
	...
	oxidation: {
		description: "Calciners produce 95% more iron and 285% more titanium.",
		effects: {
			calcinerRatio: 0.95,
		},
		label: "Oxidation",
	...
	petri: {
		description: "Each Biolab slightly improves compendia craft ratio",
		effects: {},
		label: "Petri Dishes",
		name: "petri",
		prices: [
	...
	prospecting: {
		description:
			"A small amount of iron can now be directly extracted from meteors",
		label: "Prospecting",
		name: "prospecting",
		prices: [
			{
	...
	pumpjack: {
		description:
			"Improves effectiveness of Oil Wells by 45%. Every Oil Well will consume 1Wt/t.",
		effects: {
			oilWellRatio: 0.45,
		},
		label: "Pumpjack",
	...
	railgun: {
		description:
			"Deadly electromagnetic weapon. +25% boost to catpower production",
		effects: {
			explorerAtk: 20,
			manpowerJobRatio: 0.25,
		},
	...
	rotaryKiln: {
		description: "Calciners produce 75% more iron and 225% more titanium.",
		effects: {
			calcinerRatio: 0.75,
		},
		label: "Rotary Kiln",
	...
	satelliteRadio: {
		description:
			"Every Satellite will boost the effect of Broadcast Towers by 0.5%",
		effects: {
	...
	satnav: {
		description:
			"Every satellite reduce starchart requirement of ships by 1.25%",
		effects: {
			satnavRatio: 0.0125,
		},
	...
	spaceManufacturing: {
		description:
			"Factories provide bonus to space production as 75% of factory craft ratio",
		effects: {},
	...
	spiceNavigation: {
		description:
			"Unlocks Navigation Relay. Enable you to staff kittens to explore space as a crew",
	...
	starlink: {
		description:
			"Every Data Center will provide an additional 1% bonus to Bio Labs",
		effects: {
			uplinkLabRatio: 0.01,
		},
		label: "Starlink",
	...
	stasisChambers: {
		description: "Energy Rifts are 95% more effective at storing resources.",
		effects: {
	...
	steelAxe: {
		description:
			"Very sharp and durable axes. Woodcutters are 50% more effective",
		effects: {
			woodJobRatio: 0.5,
		},
		label: "Steel Axe",
	...
	tachyonAccelerators: {
		description: "Energy Rifts are 500% more effective.",
		effects: {
			acceleratorRatio: 5,
		},
	...
	tachyonModerator: {
		...
		flavor:
			"It's also capable of automatically synchronizing cardinal grammeters.",
	...
	thoriumReactors: {
		description:
			"Increase Reactors energy output by 25% by the addition of thorium",
		effects: {
			reactorEnergyRatio: 0.25,
	...
	titaniumBarns: {
		description:
			"Storage facilities store 100% more resources. (As a general rule of thumb, upgrades stack additively to each other.)",
		effects: {
			barnRatio: 1,
		},
	...
	transportSuperposition: {
		description: "Spaceport trade volume is increased by another 50%",
		effects: {},
		flavor: "Warning: may cause paradoxes",
		label: "Transport Superposition",
	...
	unobtainiumAxe: {
		description:
			"Those axes are literally unobtainable! Woodcutters are 50% more effective.",
		effects: {
			woodJobRatio: 0.5,
		},
