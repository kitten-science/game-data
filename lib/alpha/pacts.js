...
export default {
	...
	pactOfArcane: {
		description:
			"Harness power to reshape matter, raising crafting ratio and engineers speed",
		effects: {
			necrocornPerDay: 0,
	...
	pactOfChronicler: {
		description:
			"Meticulous recordings of the past for the brighter future! Improves year related effects",
		effects: {
			necrocornPerDay: 0,
	...
	pactOfCleansing: {
		description:
			"Cleanse the mortal plane of trash! Increase global resource limits.",
		effects: {
			necrocornPerDay: 0,
