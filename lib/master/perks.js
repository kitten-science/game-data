...
export default {
	...
	alicornmancy: {
		description:
			"Increases the chance to get your first unicorns from hunting.\nAlicorn production will start instantly once unlocked.",
		label: "Alicornmancy",
		name: "alicornmancy",
		prices: [
			{
	...
	ambassadors: {
		description:
			"Unlocks the ambassador job and the ability to queue embassies.",
		label: "Ambassadors",
		name: "ambassadors",
		prices: [
			{
	...
	codexLeviathanianus: {
		description:
			"Increases compendia cut-off limit by 5% per transcendence tier",
	...
	voidOrder: {
		description:
			"Adds 10% produced faith, which is automatically converted as worship.",
