...
export default {
	...
	blackRadiance: {
		description:
			"Every % of BLS meter will very slightly increase alicorn corruption rate",
		effects: {
	...
	darkParacosm: {
		description: "Increases millennium paragon production",
		effects: {
			milleninumParagon: 1,
		},
		flavor: "Time is grand and firm teacher",
		label: "Dark Paracosm",
		name: "darkParacosm",
		priceRatio: 2,
		prices: [
