...
export default {
	...
	amphitheatre: {
		...
		stages: [
			...
			{
				description:
					"Generates culture and happiness. More effective with high energy production.",
				effects: {
					cultureMax: 300,
	...
	biolab: {
		description:
			"Improves effectiveness of catnip refinement by 10%. More effective if powered.",
		effects: {
			catnipPerTickCon: 0,
			energyConsumption: 0,
			oilPerTickProd: 0,
	...
	mine: {
		description:
			"Unlocks the miner job. Each upgrade level improves your mineral output by 20%",
		effects: {
			cathPollutionPerTickProd: 0,
			coalPerTickBase: 0,
			mineralsRatio: 0,
	...
	pasture: {
		...
		stages: [
			{
				description:
					"Provides an alternative source of food, which reduces catnip consumption.",
				effects: {
			...
			{
				description:
					"Provides an additional source of energy depending on the seasons.",
				label: "Solar Farm",
				priceRatio: 1.15,
				prices: [
					{
	...
	quarry: {
		description:
			"Quarries each improve your mining efficiency by 35% and produce a bit of coal",
		effects: {
	...
	reactor: {
		description:
			"Provides a 5% boost to production while active. Requires uranium to operate.",
		effects: {
			energyProduction: 10,
	...
	stasisPod: {
		description: "A large stasis pod suited for non-feline liveforms",
		effects: {
			zebraMax: 1,
		},
		label: "Stasis Pod",
	...
	temple: {
		description:
			"Temple of light. Produces culture. May be improved with Theology.",
		effects: {
			cultureMax: 0,
			culturePerTickBase: 0,
			faithMax: 0,
	...
	unicornPasture: {
		description:
			"Allows the taming of unicorns. Reduces catnip consumption by 0.15%",
		effects: {
	...
	workshop: {
		defaultUnlockable: true,
		description:
			"Provides a vast variety of upgrades. Improves craft effectiveness by 6%",
		effects: {
			craftRatio: 0.06,
		},
